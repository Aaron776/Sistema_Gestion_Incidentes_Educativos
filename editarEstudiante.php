...
$id_estudiante = $_GET['id_estudiante']; // ID del estudiante que se está editando
...
$sql = $conexion->prepare("SELECT estudiantes.id, estudiantes.tutor_id, estudiantes.nombre, estudiantes.apellido,estudiantes.curso,estudiantes.email,estudiantes.telefono,usuarios.nombre AS tutor FROM estudiantes LEFT JOIN usuarios ON estudiantes.tutor_id = usuarios.id WHERE estudiantes.id = :id_estudiante  LIMIT 1");
...
<div class="dashboard-content">
    <div class="page-header">
        ...
        <h1 class="page-title"><i class="fas fa-user-edit"></i> Editar Estudiante</h1>
        <p class="page-subtitle">Complete el formulario para editar un estudiante.</p>
    </div>

    <div class="form-container">
        <form id="userForm" class="user-form" action="controladores/editarEstudiantes.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tutor" name="tutor_id" required>
                            ...
                            <?php foreach ($tutores as $item) { ?>
                                <option value="<?php echo $item->id; ?>" <?php echo ($item->id == $estudiante->tutor_id) ? 'selected' : ''; ?>>
